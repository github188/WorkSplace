...
public class DataOperate {
    ...
    public DataOperate(Context con,Handler handler){
        ...
        this.path=Utils.getSDPath()+"/joysee/images/"; 
    ...
    public AppsBean getAppDetail(int appID){
        ...
        String jsonStr=mNetUtil.getAppsByStatus(param, RequestParam.SERVICE_ACTION_URL +RequestParam.Action.GETAPPDETAIL);
...
//        }
    ...
    public Boolean setScoreToService(String userId,int appID,Float appScore){
    	 ...
    	 String jsonStr=mNetUtil.getAppsByStatus(param, RequestParam.SERVICE_ACTION_URL +RequestParam.Action.USERVOTE);
    ...
    //public Boolean getScorFormService(String userId,int appID){
    	...
    	String jsonStr=mNetUtil.getAppsByStatus(param, RequestParam.SERVICE_ACTION_URL +RequestParam.Action.GETUSERISSCORE);
