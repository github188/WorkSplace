...
import com.joysee.pinyin.InputModeSwitcher.ToggleStates;
...
public class SoftKeyboard {
    ...
    public SparseArray<String> mSoftKeyLocation = new SparseArray<String>();
    ...
    public boolean addSoftKey(SoftKey softKey) {
        ...
        strContainer.append(mKeyRows.size() - 1).append("|").append(softKeys.size()-1);
        Log.d("songwenxuan","softKey.mKeyCode = " + softKey.mKeyCode + " row = " + (mKeyRows.size() - 1) + " location = " + (softKeys.size()-1));
        mSoftKeyLocation.put(softKey.mKeyCode, strContainer.toString());
