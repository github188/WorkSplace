...
//    private CandidateViewListener mCvListener;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mOldWidth != getMeasuredWidth() || mOldHeight != getMeasuredHeight()) {
            PinyinLog.d(TAG, "onMeasure(),mOldWidth != getMeasuredWidth() || mOldHeight != getMeasuredHeight()");
            onSizeChanged();
        }
    }
...
//        mCvListener = cvListener;
    ...
    public void showPage(int pageNo, int activeCandInPage,
        ...
        PinyinLog.d(TAG, "showPage() , pageNo = " + pageNo);
        mPageNo = pageNo;
...
//        mActiveCandInPage = 0;
    ...
    private boolean calculatePage(int pageNo) {
        ...
        PinyinLog.d(TAG, "calculatePage(),candSize = " + candSize);
        ...
        for (int p = fromPage; p <= pageNo; p++) {
            ...
            while (xPos < mContentWidth && pStart + pSize < candSize) {
                ...
                PinyinLog.d(TAG, "calculatePage(),itemStr = " + itemStr);
        ...
        PinyinLog.d(TAG, "calculatePage(),mPageNo = " + mPageNo);
        return true;
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // return at once.
        PinyinLog.d(TAG, "onDraw(),mPageNo = " + mPageNo);
        ...
        int yPos = (getMeasuredHeight() -
                ...
                - mFmiCandidates.top;
        xPos += drawVerticalSeparator(canvas, xPos);//返回分割线的宽度。
        for (int i = 0; i < pSize; i++) {
            ...
            PinyinLog.d(TAG, "onDraw(),candidateStr = " + cand);
            ...
            if (mActiveCandInPage == i && mEnableActiveHighlight && isEnableFocus) {
