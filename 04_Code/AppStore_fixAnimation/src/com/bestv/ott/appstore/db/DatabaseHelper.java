...
import com.bestv.ott.appstore.provider.AppStoreProvider;
...
public  class DatabaseHelper extends SQLiteOpenHelper {
	    ...
	    private static final int DATABASE_VERSION = 6;//from  version =4 start create db

	    public static final String AUTHORITY = "com.bestv.ott.appstore.authority";
	 ...
	 private static final String CREATE_DOWNLOAD_TASK_TABLE = "CREATE TABLE IF NOT EXISTS "+TABLE_TASK
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            AppLog.e(TAG, "--------------getThirdApp------count="+apps.size());
            if(db.isOpen()){
    ...
    public static final class ApplicationColumn  {
        ...
        public static final String APPSOURCE = "appsourcefinal";//是否第三方应用,之前有些是appsource,现在不用了
    }
