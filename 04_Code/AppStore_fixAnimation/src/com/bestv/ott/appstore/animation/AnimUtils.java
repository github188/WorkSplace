...
public class AnimUtils {
	...
	public static int ANIMATION_DEAYLE_TIME = 250;//不移动动画,直接到达要延迟时间,不会找此view时,它的坐标会不准,主要用于首页翻页
	
	public static int ANIMATION_MOVE_SLOW   = 300;//移动时间
	public static int ANIMATION_MOVE_FAST   = 50;
