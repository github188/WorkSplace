...
public class MoveControl {
	...
	private Animation appImage , appName,appTv;
	private View bigView , bigTextView , smallView,bigTvView;
	...
	public MoveControl(Context con,View moveView){
		...
		appTv = AnimationUtils.loadAnimation(mCon, R.anim.scale_tv_show);
...
//				alpha_all.setFillAfter(true);
	...
	public synchronized void trunBigApp(){
		...
		bigTvView = (View)viewParent.findViewById(R.id.boutique_parent);
		/* title */
		if(bigTextView!=null){
			bigTextView.startAnimation(appName);
		}
		/* boutique */
		if(bigTvView!=null && bigTvView.getVisibility()==View.VISIBLE){
		    bigTvView.startAnimation(appTv);
		}
		/* appImage */
