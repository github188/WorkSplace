...
public class AppsBean implements Parcelable{
    ...
    private int updateTag;//用于本身的升级模式  0:默认升级  1:强制升级
    private String supportDevice;//支持外设
    ...
    public AppsBean(Parcel in){
    	...
    	setUpdateTag(in.readInt());
    	setSupportDevice(in.readString());
    }
