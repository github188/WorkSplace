...
public class Constants {
	...
	public static final int APP_STATUS_UNINSTALLING = 9;//正在卸载
	...
	public static final String INTENT_DOWNLOAD_STARTED = "com.joysee.appstore.DOWNLOAD_STARTED";
	
	public static final String INTENT_DOWNLOAD_PAUSE = "com.joysee.appstore.DOWNLOAD_PAUSE";
	
	public static final String INTENT_DOWNLOAD_PROGRESS = "com.joysee.appstore.DOWNLOAD_PROGRESS";
	
	public static final String INTENT_DOWNLOAD_COMPLETED = "com.joysee.appstore.DOWNLOAD_COMPLETED";
	
	public static final String INTENT_DOWNLOAD_DETLET = "com.joysee.appstore.DOWNLOAD_DETLET";
	
	public static final String INTENT_INSTALL_COMPLETED = "com.joysee.appstore.INSTALL_COMPLETED";
	
	public static final String INTENT_UPDATE_COMPLETED = "com.joysee.appstore.UPDATE_COMPLETED";
	
	public static final String INTENT_INSTALL_SUCCESS = "com.joysee.appstore.INSTALL_SUCCESS";
	
	public static final String INTENT_INSTALL_FAIL = "com.joysee.appstore.INSTALL_FAIL";
	
	public static final String INTENT_UNINSTALL_COMPLETED = "com.joysee.appstore.UNINSTALL_COMPLETED";
	
	public static final String INTENT_DOWNLOAD_ERROR = "com.joysee.appstore.DOWNLOAD_ERROR";
	
	public static final String PACKAGENAME = "com.joysee.appstore";
	
	public static final String INTENT_ACTION_APPSTORE = "joysee.action.appstore";
	...
	public static final String INTENT_ACTION_RESTART_SERVICES = "com.joysee.restart_service";
	...
	public static final String IMAGEROOT="/data/data/com.joysee.appstore/files/images/";//如果没有sd card，就会把图片存在这个目录下
	public static final String APKROOT="/data/data/com.joysee.appstore/files";//如果没有sd card ,apk下载到此目录
	...
	public static final class Delayed{
	    ...
	    public static final int TIME2=200;
	    ...
	    public static final int SEC_10=10*1000;
	    public static final int SEC_5=5*1000;
	    public static final int MIN_10=10*60*1000;
	}
	...
	public static boolean update=false;//表示下载完了要不要执行静默安装，如果当前没有页面为true
	public static boolean enforce=false;//表示是否为强制升级
	public static int activitys=0;
}
