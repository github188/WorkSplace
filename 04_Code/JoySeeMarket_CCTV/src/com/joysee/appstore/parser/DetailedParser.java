...
public class DetailedParser extends BaseParser<AppsBean>{
	...
	public static final String TAG_SUPPORT="extrnalName";
	...
	public AppsBean parseJSON(String paramString, PageBean pageBean)
        ...
        AppLog.d("TAG", "&&&&祥情="+appObj.toString());
        ...
        if(appObj.has(TAG_SUPPORT)){
        	appBean.setSupportDevice(appObj.getString(TAG_SUPPORT));
        }
