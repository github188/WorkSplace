...
//            tb.setBackgroundDrawable(null);
            tb.setTextColor(getResources().getColor(R.color.text_white));
...
//        	clickBut.setBackgroundResource(R.drawable.button_selected);
        	clickBut.setTextColor(getResources().getColor(R.color.text_yellow));
        }
    }
...
//            tb.setBackgroundDrawable(null);
            ...
            if((Integer)tb.getTag()==position){
            	...
            	tb.setTextColor(getResources().getColor(R.color.text_yellow));
            	return;
            }
        }
    }
