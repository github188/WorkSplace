 ...
 * 
 * 直接使用里面的静态方法即可
 *  {@link #getDefaultTransponder}
 * 和 {@link #saveDefaultTransponer}
 * 
 * @author dr
 *
 */
public class TransponderUtil {
    ...
    private static final DvbLog log = new DvbLog("novel.supertv.dvb.utils.TransponderUtil",DvbLog.DebugType.D);
     ...
     * @return
     */
    public static TuningParam getDefaultTransponder(Context context, int defaultTpType){
        
        SharedPreferences mySharedPreferences = 
            context.getSharedPreferences(DefaultParameter.PREFERENCE_NAME, Activity.MODE_PRIVATE);
        
        TuningParam defaultTp[] = new TuningParam[3];
        
        // 全频 0
        defaultTp[DefaultParameter.DefaultTransponderType.DEFAULT_TRANSPONDER_TYPE_MAINTP] 
                  = new TuningParam();
     ...
     */
    public static void saveDefaultTransponer(Context context, int defaultTpType, TuningParam tp){
        ...
        if (defaultTpType == DefaultParameter.DefaultTransponderType.DEFAULT_TRANSPONDER_TYPE_MAINTP) {
    ...
    public static void saveDefaultTransponer(Context context){
        ...
        SharedPreferences mySharedPreferences = 
            ...
            editor.commit();
            AdapterViewSelectionUtil.showToast(context, R.string.search_resset_success);
