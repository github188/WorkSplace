...
public class DefaultParameter {
    ...
    public static final class ServiceType{
        public static final int reserved_for_future_use = 0;//预留
        public static final int digital_television_service = 1;//数字电视业务
        public static final int digital_radio_sound_service = 2;//数字音频广播业务
        public static final int Teletext_service = 3;//图文电视业务
        public static final int NVOD_reference_service = 4;//NVOD参考业务
        public static final int NVOD_timeshifted_service = 5;//NVOD时移业务
        public static final int mosaic_service = 6;//马赛克业务
        public static final int PAL_coded_signal = 7;//PAL制编码信号
        public static final int SECAM_coded_signal = 8;//SECAM制编码信号
        public static final int D_D2_MAC = 9;//D/D2-MAC
        public static final int FM_Radio = 10;//调频广播
        public static final int NTSC_coded_signal = 11;//NTSC制信号
        public static final int data_broadcast_service = 12;//数据广播业务
        public static final int reserved_for_Common_Interface_Usage = 13;//公共接口使用预留
        public static final int RCS_Map = 14;//RCS映射
        public static final int RCS_FLS = 15;//RCS FLS
        public static final int DVB_MHP_service = 16;//DVB MHP业务
    }
...
//        public static final int MODULATION_UNDEFINE = 0x00;
    ...
    public static final class DefaultTransponderType{
        /** 全频 */
        public static final int DEFAULT_TRANSPONDER_TYPE_MAINTP = 1;
        /** 手动 */
    ...
    public static final class DefaultTpValue{
        public static final int FREQUENCY = 602000;
