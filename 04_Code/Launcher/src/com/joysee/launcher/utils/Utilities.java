...
public final class Utilities {
    ...
    public static Bitmap createLauncherBackground(int resId,Context context){
    	BitmapDrawable bitmapDrawable = (BitmapDrawable) context.getResources()
				.getDrawable(R.drawable.joysee_launcher_bg);
		Bitmap tv_bg = bitmapDrawable.getBitmap();

		Bitmap bg = Bitmap.createBitmap(tv_bg.getWidth(), tv_bg.getHeight(),
				Bitmap.Config.ARGB_8888);
		Canvas c = new Canvas(bg);
		Paint paint = new Paint();

		Rect bgLeft = new Rect(0, 0, 1146, 1080);
		Rect bgRight = new Rect(1866, 0, 1920,1080);
		Rect bgTop = new Rect(1146, 0, 1866,371);
		Rect bgBottom = new Rect(1146, 924,1920, 1080);

		c.drawBitmap(tv_bg, bgLeft, bgLeft, paint);
		c.drawBitmap(tv_bg, bgRight, bgRight, paint);
		c.drawBitmap(tv_bg, bgTop, bgTop, paint);
		c.drawBitmap(tv_bg, bgBottom, bgBottom, paint);
    	return bg;
    }
